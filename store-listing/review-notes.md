...
- All data is stored locally with chrome.storage.local: timer state, session count, a per-day history used for the statistics, the selected theme, and the five settings toggles.
